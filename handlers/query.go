...
var (
	// 禁止するSQLキーワード
	forbiddenKeywords = regexp.MustCompile(`(?i)(INSERT|UPDATE|DELETE|DROP|CREATE|ALTER|TRUNCATE|EXEC|EXECUTE|GRANT|REVOKE|UNION|INTO|FILE|OUTFILE|DUMPFILE|LOAD_FILE|BENCHMARK|SLEEP|WAITFOR|PRAGMA|ATTACH|DETACH)`)
